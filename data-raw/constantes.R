...
colores_opinion_2 <-
  c("Pésima" = color_opinion_muyMala,
    "Mala" = color_opinion_mala,
    "Regular" = color_opinion_regular,
    "Buena" = color_opinion_buena,
    "Excelente" = color_opinion_muyBuena)
...
colores_generacion_polig <-c(
"A. 18 a 24 años"  = color_mucho,
"B. 25 a 34 años" =color_cuartil_1,
"C. 35 a 44 años" = color_algo,
"D. 45 a 54 años"  = color_cuartil_2,
"E. 55 a 64 años" = color_poco,
"F. 65 años o más" = color_hagamos)
